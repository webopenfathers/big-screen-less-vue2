  ...
  <div>
    <div class="screen-content">
      ...
      <div class="header">
        ...
        <div class="header-center text-gradient" @click="next">DR作战大厅</div>
...
export default {
  ...
  methods: {
    next() {
      ...
      const examplePage = window.open(routerLink.href, '666')

      if (examplePage) {
        examplePage.focus() // 如果页面已经存在，‌则聚焦到该页面
      } else {
        // 如果页面不存在，‌则打开新页面
        window.open(routerLink.href, '666')
      }
    },
    //获取年月日的方法
    getYearMonthDay() {
